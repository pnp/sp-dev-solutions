              ...
              groupFields:[
                ...
                PropertyFieldCamlQueryFieldMapping('advancedCamlQuery',{
                  ...
                  createFields:[
                    ...
                    '<Field Type="Boolean" DisplayName="HasBlueBackground" Required="FALSE" EnforceUniqueValues="FALSE" Indexed="FALSE" Group="Shire Hub Columns" ID="{f9ba1903-e7be-42cd-843e-f898d4c1fcb4}" SourceID="{f9ba1903-e7be-42cd-843e-f898d4c1fcb4}" StaticName="HasBlueBackground" Name="HasBlueBackground" Version="5" />',
