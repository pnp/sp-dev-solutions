define([], function() {
  return {
    ...
    "UsePaginationWebPartLabel": "Connect to the Search Pagination webpart",
    "AppliedRefinersFieldLabel": "Applied refiners",
    "RefinersConfigurationFieldLabel": "Refiners configuration",
    "ExternalConnectionsGroupName": "External connection settings",
    "SearchPaginationFieldLabel": "Search pagination",
    "SelectedPageFieldLabel": "Selected page",
