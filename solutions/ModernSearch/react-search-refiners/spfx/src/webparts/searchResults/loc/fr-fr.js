define([], function() {
  return {
    ...
    "UsePaginationWebPartLabel": "Connectez-vous au composant Web Part de pagination de recherche",
    "AppliedRefinersFieldLabel": "Filtre(s) appliqué(s)",
    "RefinersConfigurationFieldLabel": "Configuration des filtres",
    "ExternalConnectionsGroupName": "Paramètres de connexion externe",
    "SearchPaginationFieldLabel": "Pagination de recherche",
    "SelectedPageFieldLabel": "Page sélectionnée",
