define([], function () {
  return {
    "DynamicFieldLabel": "Conectar al Web Part de caja de búsqueda",
    "NavNodeLabel": "Nodos de navegación",
    "NavNodeHeader": "Nodos de navegación",
    "NavNodeManageBtnLabel": "Editar nodos de navegación",
    "NavNodeDisplayTextFieldLabel": "Displaytext",
    "NavNodeUrlFieldLabel": "Url",
    "ColorPickerLabel": "Color",
    "UseThemeColorLabel": "Usar tema primario",
    ...
    "SearchBoxSameTabOpenBehavior": "Usar la pestaña actual",
    "SearchBoxNewTabOpenBehavior": "Abrir en una nueva pestaña",
    "SearchBoxPageOpenBehaviorLabel": "Comportamiento de apertura"
  }
});