define([], function() {
  return {
    ...
    Property_EditorThemeLabel: "Design",
    ...
    Welcome_UploadInstructions1: 'JSON Datei hier herziehen, oder hier klicken um Datei auszuwählen.',
    ...
    Color_Orange: 'Orange',
    Color_OrangeLight: 'Orange hell',
    Color_OrangeLighter: 'Orange sehr hell',
    Color_RedDark: 'Dunkelrot',
    Color_Red: 'Rot',
    Color_MagentaDark: 'Magenta dunkel',
    Color_Magenta: 'Magenta',
    Color_MagentaLight: 'Magenta hell',
    Color_PurpleDark: 'Violett dunkel',
    Color_Purple: 'Violett',
    Color_PurpleLight: 'Violett hell',
    Color_BlueDark: 'Dunkelblau',
    Color_BlueMid: 'Blau mittel',
    Color_Blue: 'Blau',
    Color_BlueLight: 'Hellblau',
    Color_TealDark: 'Blaugrün dunkel',
    Color_Teal: 'Blaugrün',
    Color_TealLight: 'Blaugrün hell',
    Color_GreenDark: 'Dunkelgrün',
    Color_Green: 'Grün',
    Color_GreenLight: 'Hellgrün',
    Color_Black: 'Schwarz',
    Color_NeutralDark: 'Neutral dunkel',
    Color_NeutralPrimary: 'Neutral primär',
    Color_NeutralPrimaryAlt: 'Neutral primäre alt',
    Color_NeutralSecondary: 'Neutral sekundäre',
    Color_NeutralTertiary: 'Neutral Tertiär',
    Color_NeutralTertiaryAlt: 'Neutral Tertiär alt',
    Color_NeutralLight: 'Neutral hell',
    Color_NeutralLighter: 'Neutral sehr hell',
    Color_NeutralLighterAlt: 'Neutral sehr hell alt',
    Color_White: 'Weiß',
    ...
    WizardMailTo_Description: 'Erstellt Link für Email an Person in Spalte',
    WizardMailTo_Subject: 'Betreff',
    WizardMailTo_DefaultSubject: 'Diverses',
    WizardMailTo_Body: 'Nachricht',
    ...
    WizardFlow_Description: 'Erstellt eine Link zum einfachen Starten eines Flows',
    WizardFlow_FlowId: 'Flow id',
    WizardFlow_FlowIdInstructions: 'Aus der Detailansicht des Flows kopieren Sie den Teil der URL zwischen flows/ und /details\nZb: für "flows/40ae7493-a7c7-41af-9f54-3d83f32c4b56/details"\n ist die ID: "40ae7493-a7c7-41af-9f54-3d83f32c4b56"',

    //Wizard Donut
    WizardDonut_Name: 'Tortendiagramm',
    WizardDonut_Description: 'Zeigt Werte mit einem Torten- oder Kreisdiagramm an',
    WizardDonut_Donut: 'Kreisdiagramm',
    WizardDonut_Pie: 'Tortendiagramm',
    ...
    WizardTwitter_Description: 'Zeigt Twitter-Profilbilder des Twitter-Handles an',
    WizardTwitter_Rounding: 'Rundung',
    WizardTwitter_LinkOn: 'Link zum Profil',
    WizardTwitter_LinkOff: 'Kein Link'
  }
});