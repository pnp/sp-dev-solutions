define([], function() {
  return {
    ...
    ViewFormatter: 'View Formatter',

    //Welcome
    Welcome_Title: 'List Formatter',
    Welcome_SubTitle: 'Easy editor for modern listview Formatting',
    Welcome_NewCFHeader: 'New Column Formatter',
    Welcome_NewCFDescription: 'Customize the look of a field or site column',
    Welcome_NewVFHeader: 'New View Formatter',
    Welcome_NewVFDescription: 'Customize the look of rows in a list view',
    ...
    Welcome_NewNoTemplates: 'No templates available for your current selection',
    Welcome_BackButton: 'Back',
    Welcome_OKButton: 'OK',
    Welcome_NextButton: 'Next',
    Welcome_OpenLoadList: 'Load from a local list field (Column Formatter)',
    Welcome_OpenLoadSiteColumn: 'Load from a site column (Column Formatter)',
    Welcome_OpenLoadListView: 'Load from a local list view (View Formatter)',
