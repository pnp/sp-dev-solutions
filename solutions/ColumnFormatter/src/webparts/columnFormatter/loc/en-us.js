define([], function() {
  return {
    ...
    //Wizard Controls
    ColorYellow: 'Yellow',
    ColorYellowLight: 'Yellow Light',
    ColorOrange: 'Orange',
    ColorOrangeLight: 'Orange Light',
    ColorOrangeLighter: 'Orange Lighter',
    ColorRedDark: 'Red Dark',
    ColorRed: 'Red',
    ColorMagentaDark: 'Magenta Dark',
    ColorMagenta: 'Magenta',
    ColorMagentaLight: 'Magenta Light',
    ColorPurpleDark: 'Purple Dark',
    ColorPurple: 'Purple',
    ColorPurpleLight: 'Purple Light',
    ColorBlueDark: 'Blue Dark',
    ColorBlueMid: 'Blue Mid',
    ColorBlue: 'Blue',
    ColorBlueLight: 'Blue Light',
    ColorTealDark: 'Teal Dark',
    ColorTeal: 'Teal',
    ColorTealLight: 'Teal Light',
    ColorGreenDark: 'Green Dark',
    ColorGreen: 'Green',
    ColorGreenLight: 'Green Light',
    ColorBlack: 'Black',
    ColorNeutralDark: 'Neutral Dark',
    ColorNeutralPrimary: 'Neutral Primary',
    ColorNeutralPrimaryAlt: 'Neutral Primary Alt',
    ColorNeutralSecondary: 'Neutral Secondary',
    ColorNeutralTertiary: 'Neutral Tertiary',
    ColorNeutralTertiaryAlt: 'Neutral Tertiary Alt',
    ColorNeutralLight: 'Neutral Light',
    ColorNeutralLighter: 'Neutral Lighter',
    ColorNeutralLighterAlt: 'Neutral Lighter Alt',
    ColorWhite: 'White',
    ...
    WizardDonutDescription: 'Shows values using a donut or pie chart',
