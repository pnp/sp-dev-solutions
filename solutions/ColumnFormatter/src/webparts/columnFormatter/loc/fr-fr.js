define([], function() {
  return {
    ...
    WelcomeSubTitle: 'Éditeur simplifier pour la mise en forme de colonne pour l\'expérience moderne',
    WelcomeNewHeader: 'Nouveau',
    WelcomeNewDescription: 'Commencez à partir de zéro ou choisissez un modèle',
    WelcomeOpenHeader: 'Ouvrir',
    WelcomeOpenDescription: 'Charger depuis une bibliothèque ou récupéré d\'une liste locale',
    ...
    WelcomeOpenLoadList: 'Charger à partir d\'une liste locale',
    WelcomeOpenLoadSiteColumn: 'Charger à partir d\'une colonne de site',
    WelcomeOpenLoadFile: 'Charger à partir d\'un fichier :',
    ...
    TabPreview: 'Aperçu',
    TabCode: 'Code',
    TabSplit: 'Cote à cote',

    //Panel Headers
    PanelHeaderData: 'Valeurs de test',
    PanelHeaderPreview: 'Aperçu',
    PanelHeaderCode: 'Éditeur de code',

    //Editor CommandBar
    CommandNew: 'Nouveau',
    CommandCustomize: 'Personnaliser',
    CommandEditor: 'Thème',
    CommandSaveAs: 'Enregistrer sous',
    ...
    NewConfirmationDialogText: 'Tout changement non enregistré sera perdu. Voulez-vous continuer ?',
    NewConfirmationDialogConfirmButton: 'Oui',
    NewConfirmationDialogCancelButton: 'Annuler',

    //Customize Confirmation Dialog
    CustomizeConfirmationDialogTitle: 'Enlever l\'assistant ?',
    CustomizeConfirmationDialogText: 'Vous serez en mesure de modifier le code directement, mais le volet de l\'assistant ne sera plus disponible. Ceci est pour les utilisateurs avancés. Êtes-vous sûr ?',
    ...
    DeleteColumn: 'Supprimer le champ',
    AddColumn: 'Ajouter le champ',

    //Data Column Editing
    ColumnNameChangeTooltip: 'Nom du champ interne',
    ColumnTypeHeadline: 'Type de colonne',
    ColumnTypeMessage: 'Changer le type réinitialisera également les valeurs',
    ...
    ColumnTypeChoice: 'Choix',
    ColumnTypeDateTime: 'Date / heure',
    ColumnTypeLink: 'Hyperlien',
    ColumnTypePicture: 'Image',
    ColumnTypeLookup: 'Lookup',
    ColumnTypeNumber: 'Nombre',
    ColumnTypePerson: 'Personne',
    ColumnTypeText: 'Texte',
    ColumnTypeUnknown: 'Inconnu',
    ...
    Day6Short: 'V',
    Day7Short: 'S',
    DTgoToToday: 'Aujourd\'hui',
    DTprevMonthAriaLabel: 'Aller au mois précédent',
    DTnextMonthAriaLabel: 'Aller au mois suivant',
    DTprevYearAriaLabel: 'Aller à l\'année précédente',
    DTnextYearAriaLabel: 'Aller à l\'année prochaine',
    HourLabel: 'Heure',
    MinuteLabel: 'Minute',
    SecondsLabel: 'Seconde',

    //Custom Formatting Error Strings
    CFSariaError: 'Aucune étiquette trouvée. En tant que tel, le champ ne sera pas accessible via un lecteur d\'écran.',
    CFSelmTypeInvalid: 'ElmType non valide: {0}. Doit être l\'un de {1}.',
    CFSelmTypeMissing: 'Doit spécifier elmType.',
    CFSinvalidProtocol: 'Une URL a été bloquée. Seuls les protocoles http, https et mailto sont autorisés.',
    CFSinvalidStyleAttribute: '"{0}" n\'est pas un attribut de style pris en charge.',
    CFSinvalidStyleValue: 'Les valeurs de style "{0}" contiennent un ou plusieurs des caractères non autorisés suivants ( : & ; ! .',
    CFSnan: '{0} n\'est pas un nombre. Nombre attendu dans l\'expression {1}.',
    CFSoperandMissing: 'Il doit y avoir au moins 1 opérande dans l\'expression {0}.',
    CFSoperandNOnly: '{0} attendant opérande (s) pour l\'expression {1}.',
    CFSoperatorInvalid: '"{0}" n\'est pas un opérateur valide. Ce doit être l\'un de {1} dans l\'expression {2}.',
